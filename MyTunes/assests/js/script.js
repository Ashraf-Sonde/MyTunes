...
function removeFromPlaylist(button, playlistId) {
    ...
    $.post("includes/handlers/ajax/removeFromPlaylist.php", { playlistId: playlistId, songId: songId }).done(function(error) {
        ...
        //do some task when AJAX returns
...
function deletePlaylist(playlistId) {
    var prompt = confirm("Are your sure you want to delete this playlist");
...
function updateTimeprogressBar(audio) {
    $(".progressTime.current").text(formatTime(audio.currentTime));         // updating the current playtime
    $(".progressTime.remaining").text(formatTime(audio.duration - audio.currentTime));          //updating the remaining time
...
function Audio() {
    ...
    this.audio.addEventListener("timeupdate", function() {
        if(this.duration) {
            updateTimeprogressBar(this);        // this == audio
        }
    });
